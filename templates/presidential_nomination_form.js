...
module.exports = (data) => {
    ...
    const candidateName = data.nominationData.candidateData.candidateName;
    const occupation = data.nominationData.candidateData.occupation;
    const address = data.nominationData.candidateData.address;
...
<div style="padding: 20px;padding-left: 50px; text-align:center;">

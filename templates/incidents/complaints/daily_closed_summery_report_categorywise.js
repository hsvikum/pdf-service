        ...
        <tr>
          ...
          <th style="border: none; width: 150px">
				...
				<tr class="grey" style="height: 70px;">
					<th colspan="3">
					<div>
					දෛනික සාරාංශ වාර්තාව - කාණ්ඩය මගින් වසා ඇති ඉල්ලීම් ගණන
					</div>
					<div class="font-small">
					தினசரி சுருக்க அறிக்கை - வகையால் மூடப்பட்ட கோரிக்கைகளின் எண்ணிக்கை
					</div>
					<div>
					Daily Summary Report - No. of requests closed by Category
					</div>
					</th>
				</tr>
				<tr>
